...
''' 
todo:
 done) by arg - clean part taxonomy or make old taxonomies or what
 done) send partial_taxonomy_result file name by args
 done) check species - if genus is repeated - remove
...
class Taxonomy:
    ...
    def __init__(self):
        ...
        ordered_names2 = ["superkingdom", "kingdom", "phylum", "class", "order", "family", "genus", "species", "subspecies"]
        ...
        self.bad_value     =  ["unidentified", "sp.", "cf.", "aff.", "gen.", "nr.", "str.", "genomosp.", "n.", "unidentified_sp.", "genosp.", "(sen.", "uncultured"]
    ...
    def get_next_available_rank(self, hey_of_ranks, end_rank = "subspecies"):
    ...
    def make_clean_taxonomy_from_partial(self, json_res_file_name):
        ...
        print "=====000"
        print self.ncbi_classification
        print "=====111"
        
                
        self.ncbi_classification_by_sp_good = self.make_gna_result_dict_by_key('subspecies', self.ncbi_classification, self.ncbi_classification_by_sp) 
        ...
        # print self.taxonomy
        # print "=====111"
        self.write_dict_to_file("genus_taxonomy_dict.txt", self.taxonomy, 'a')
    ...
    def is_good(self, taxon, bad_value):
        try:
          single_value = self.get_first(tax_line[name])                    
          if single_value in bad_value:
              single_value = ''
    ...
    def get_list_last_good(self, tax_infile_name):
      ...
      for line in open(tax_infile_name):
        ...
        for taxon in reversed(split_tax):
          # print "taxon = %s" % taxon
          if taxon not in self.bad_value and taxon.isalpha():          
            last_good_dict_by_id[id_tax] = taxon
            break
            
      # print "last_good_dict_by_id"
      # print last_good_dict_by_id
      self.write_dict_to_file("last_good_dict_by_id.txt", last_good_dict_by_id, "a")
